...
const habilidades = ref([
  {
    ...
    habilidades: [
      ...
      { id: 1, nombre: 'JavaScript', nivel: 'Principiante', icono: img1 },
      { id: 2, nombre: 'Python', nivel: 'Principiante', icono: img2 },
  ...
  },
  {
    ...
    habilidades: [
      { id: 1, nombre: 'React.js', nivel: 'Principiante', icono: img6 },
      { id: 2, nombre: 'Vue.js', nivel: 'Principiante', icono: img7 },
      { id: 3, nombre: 'Node.js', nivel: 'Principiante', icono: img8 },
      { id: 4, nombre: 'Django', nivel: 'Principiante', icono: img9 },
      { id: 5, nombre: 'Bootstrap', nivel: 'Principiante', icono: img10 },
    ],
  },
  {
    id: 3,
    ...
    habilidades: [
      { id: 1, nombre: 'Git', nivel: 'Principiante', icono: img11 },
      { id: 2, nombre: 'Docker', nivel: 'Principiante', icono: img12 },
      { id: 3, nombre: 'Cypress', nivel: 'Principiante', icono: img13 },
      { id: 4, nombre: 'Figma', nivel: 'Principiante', icono: img14 },
      {
        id: 5,
  ...
  },
  {
    ...
    habilidades: [
      { id: 1, nombre: 'MongoDB', nivel: 'Principiante', icono: img16 },
      { id: 2, nombre: 'MySQL', nivel: 'Principiante', icono: img17 },
      { id: 3, nombre: 'PostgreSQL', nivel: 'Principiante', icono: img18 },
    ],
  },
  {
    id: 5,
